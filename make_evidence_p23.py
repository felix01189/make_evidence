...
# 1. Sample analysis: Question, db scheme, column description, value sample and gold evidence are given as samples. Understand each and analyze the correlation between them.
# 2. Problem analysis: Understand each of the given questions, db schema, column description, and value sample to generate evidence for a problem. And detect the word or phrase that needs evidence in the question.
# 3. Create evidence: Create evidence by reflecting the sample analysis of 1 for the word or phrase detected in 2. Describe the process of generation in detail, and produce evidence in as short a sentence as possible.
# 4. Print answer: Print your answers in json format of "reasoning" and "evidence".
"""
