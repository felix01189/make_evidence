...
# 1 - Read the question.
# 2 - Analyze the database schema, database column descriptions and database value samples. 
# 3 - Understand the relation between the database and the question.
# 4 - Generate evidence so that it is as short as possible and contains as much information as possible.
# 5 - Answer in json format without code block or explanation. Format instructions: "reasoning", "evidence".
