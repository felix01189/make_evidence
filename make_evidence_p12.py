...
1. DB Schema of Samples
{
    CREATE TABLE playstore (
        App              TEXT,    ### original_column_name: App, column_name: , column_description: Application name, data_format: text, value_description:    ### column value examples: Photo Editor & Candy Camera & Grid & ScrapBook, Coloring book moana, U Launcher Lite – FREE Live Cool Themes, Hide Apps, Sketch - Draw & Paint, Pixel Draw - Number Art Coloring Book
        Category         TEXT,    ### original_column_name: Category, column_name: , column_description: Category the app belongs to, data_format: text, value_description: FAMILY 18% GAME 11% Other (7725) 71%   ### column value examples: ART_AND_DESIGN, AUTO_AND_VEHICLES, BEAUTY, BOOKS_AND_REFERENCE, BUSINESS
        Rating           REAL,    ### original_column_name: Rating, column_name: , column_description: Overall user rating of the app (as when scraped), data_format: real, value_description:    ### column value examples: 4.1, 3.9, 4.7, 4.5, 4.3
        Reviews          INTEGER,    ### original_column_name: Reviews, column_name: , column_description: Number of user reviews for the app (as when scraped), data_format: integer, value_description:    ### column value examples: 159, 967, 87510, 215644, 167
        Size             TEXT,    ### original_column_name: Size, column_name: , column_description: Size of the app (as when scraped), data_format: text, value_description: Varies with device 16% 11M 2% Other (8948) 83%   ### column value examples: 19M, 14M, 8.7M, 25M, 2.8M
        Installs         TEXT,    ### original_column_name: Installs, column_name: , column_description: Number of user downloads/installs for the app (as when scraped), data_format: text, value_description: 1,000,000+ 15% 10,000,000+ 12% Other (8010) 74%   ### column value examples: 10,000+, 500,000+, 5,000,000+, 50,000,000+, 100,000+
        Type             TEXT,    ### original_column_name: Type, column_name: , column_description: Paid or Free, data_format: text, value_description: Only has 'Paid' and 'Free' Free 93% Paid 7%   ### column value examples: Free, Paid, NaN
        Price            TEXT,    ### original_column_name: Price, column_name: , column_description: Price of the app (as when scraped), data_format: text, value_description: 0 93% $0.99 1% Other (653) 6% commonsense evidence: Free means the price is 0.   ### column value examples: 0, $4.99, $3.99, $6.99, $1.49
        [Content Rating] TEXT,    ### original_column_name: Content Rating, column_name: , column_description: Age group the app is targeted at - Children / Mature 21+ / Adult, data_format: text, value_description: Everyone 80% Teen 11% Other (919) 8% commonsense evidence: According to Wikipedia, the different age groups are defined as: Children: age<12~13 Teen: 13~19 Adult/Mature: 21+    ### column value examples: Everyone, Teen, Everyone 10+, Mature 17+, Adults only 18+
        Genres           TEXT    ### original_column_name: Genres, column_name: , column_description: An app can belong to multiple genres (apart from its main category)., data_format: text, value_description: Tools 8% Entertainment 6% Other (9376) 86%   ### column value examples: Art & Design, Art & Design;Pretend Play, Art & Design;Creativity, Art & Design;Action & Adventure, Auto & Vehicles
    );

    CREATE TABLE user_reviews (
        App                    TEXT REFERENCES playstore (App),    ### original_column_name: App, column_name: , column_description: Name of app, data_format: text, value_description:    ### column value examples: 10 Best Foods for You, 104 找工作 - 找工作 找打工 找兼職 履歷健檢 履歷診療室, 11st, 1800 Contacts - Lens Store, 1LINE – One Line with One Touch
        Translated_Review      TEXT,    ### original_column_name: Translated_Review, column_name: , column_description: User review (Preprocessed and translated to English), data_format: text, value_description: nan 42% Good 0% Other (37185) 58%   ### column value examples: I like eat delicious food. That's I'm cooking food myself, case "10 Best Foods" helps lot, also "Best Before (Shelf Life)", This help eating healthy exercise regular basis, nan, Works great especially going grocery store, Best idea us
        Sentiment              TEXT,    ### original_column_name: Sentiment, column_name: , column_description: Overall user rating of the app (as when scraped), data_format: text, value_description: commonsense evidence: Positive: user holds positive attitude towards this app Negative: user holds positive attitude / critizes on this app Neural: user holds neural attitude nan: user doesn't comment on this app.   ### column value examples: Positive, nan, Neutral, Negative
        Sentiment_Polarity     TEXT,    ### original_column_name: Sentiment_Polarity, column_name: Sentiment Polarity, column_description: Sentiment polarity score, data_format: text, value_description: commonsense evidence: ??score >= 0.5 it means pretty positive or pretty like this app. ??0 <= score < 0.5: it means user mildly likes this app. ??-0.5 <= score < 0: it means this user mildly dislikes this app or slightly negative attitude ??score <-0.5: it means this user dislikes this app pretty much.   ### column value examples: 1.0, 0.25, nan, 0.4, 0.6000000000000001
        Sentiment_Subjectivity TEXT    ### original_column_name: Sentiment_Subjectivity, column_name: Sentiment Subjectivity, column_description: Sentiment subjectivity score, data_format: text, value_description: commonsense evidence: more subjectivity refers to less objectivity, vice versa.   ### column value examples: 0.5333333333333333, 0.28846153846153844, nan, 0.875, 0.3
    );
}
